                    ...
                    <Row>
                        <Col md={4}>
                            <div className="left-container text-start">
                                ...
                                <span className="footer_name"><i className="fab fa-etsy"></i><span className='commerce'>-commerce</span> </span>
                                ...
                                <p className="mt-5">
                                    <small>E-commerce &copy; All rights </small>
                                </p>
                            </div>
                        </Col>
