        ...
        <Container sx={{ mt: "30px" }}>
            ...
            <Grid container spacing={2} sx={{paddingBottom:"15px",paddingRight:"15px",borderRadius:"10px"}}>
                <Grid item md={5} sm={6} xs={12} >
                    <Magnifier src={product.src[indexNumber]} width="100%" height="500px"  style={{ borderRadius: "5px", boxShadow: "rgba(50, 50, 93, 0.25) 0px 13px 27px -5px, rgba(0, 0, 0, 0.3) 0px 8px 16px -8px" }} />
                </Grid>
